      ...
      <main className="flex-grow p-12">
        <div className="w-full h-full flex flex-col gap-8">
          ...
          <section className="flex gap-8">
            ...
            {/* Card de Medalhas */}
            <div className="w-1/3 bg-gray-700 rounded-lg flex flex-col items-center justify-center p-4">
          ...
          <section className="flex-grow flex gap-8">
            <div className="w-1/4 flex flex-col gap-8">
              <div className="bg-gray-700 rounded-lg flex-1 flex items-center justify-center">Streak de Exercícios</div>
              <div className="bg-gray-700 rounded-lg flex-1 flex items-center justify-center">Certificados</div>
            </div>
