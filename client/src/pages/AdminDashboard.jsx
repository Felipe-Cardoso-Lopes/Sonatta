      ...
      <div className="flex-grow flex flex-col">
        <main className="flex-grow flex flex-col items-center justify-center p-8">
          ...
          <section className="flex gap-12">
            ...
            <Link to="/admin/overview" className="group flex flex-col items-center text-center">
            ...
            <Link to="/admin/management" className="group flex flex-col items-center text-center">
              <div className="w-[260px] h-[390px] rounded-[15px] bg-white flex flex-col items-center justify-center transition-transform group-hover:scale-105">
            ...
            <Link to="/admin/financial" className="group flex flex-col items-center text-center">
              <div className="w-[260px] h-[390px] rounded-[15px] bg-white flex flex-col items-center justify-center transition-transform group-hover:scale-105">
            ...
            <Link to="/admin/settings" className="group flex flex-col items-center text-center">
              <div className="w-[260px] h-[390px] rounded-[15px] bg-white flex flex-col items-center justify-center transition-transform group-hover:scale-105">
