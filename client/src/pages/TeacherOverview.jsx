...
function TeacherOverview() {
  ...
  useEffect(() => {
    if (!userId || userId === 'null' || userId === 'undefined') {
      console.warn("Socket.io aguardando ID do usuário...");
      return;
    }
  ...
  // 5. PERGUNTA QUEM ESTÁ ONLINE ASSIM QUE A LISTA CARREGAR
  useEffect(() => {
                  ...
                  <div className="bg-gray-800 p-4 border-b border-gray-700 flex items-center gap-3 shadow-md z-10">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-400">
                        {onlineUsers.has(String(activeChatStudent.id)) ? <span className="text-green-400">Online</span> : 'Offline'}
                      </p>
                    </div>
                  </div>
