        ...
        <main className="flex-grow flex flex-col items-center justify-center p-8">
          <div className="text-center w-full mb-8">
            ...
            <div className="flex flex-wrap justify-center gap-6 mb-8">
              <div className="bg-dark-gray px-8 py-4 rounded-lg border border-purple-700 shadow-md min-w-[150px]">
              ...
              <div className="bg-dark-gray px-8 py-4 rounded-lg border border-blue-700 shadow-md min-w-[150px]">
          ...
          <section className="flex flex-col xl:flex-row flex-wrap justify-center gap-8 md:gap-12 w-full px-4 md:px-0">
            <Link to="/super-admin/schools" className="group flex flex-col items-center text-center w-full md:w-auto max-w-[260px] md:max-w-none">
              ...
              <span className="opacity-0 group-hover:opacity-100 transition-opacity font-semibold text-lg mt-4 text-white-text">Gestão de Escolas</span>
            </Link>
            ...
            <Link to="/super-admin/subscriptions" className="group flex flex-col items-center text-center w-full md:w-auto max-w-[260px] md:max-w-none">
              ...
              <span className="opacity-0 group-hover:opacity-100 transition-opacity font-semibold text-lg mt-4 text-white-text">Assinaturas SaaS</span>
            </Link>
            ...
            <Link to="/super-admin/system" className="group flex flex-col items-center text-center w-full md:w-auto max-w-[260px] md:max-w-none">
              ...
              <span className="opacity-0 group-hover:opacity-100 transition-opacity font-semibold text-lg mt-4 text-white-text">Sistema e Logs</span>
            </Link>
          </section>
        </main>
      </div>
