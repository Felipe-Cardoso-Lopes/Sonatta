      ...
      <div className="flex-grow flex flex-col">
        <main className="flex-grow flex flex-col items-center justify-center p-8">
          <div className="text-center w-full mb-12">
            ...
            <h2 className="text-2xl mb-4">Painel Instituicaoistrativo Sonatta</h2>
            <p className="text-lg leading-relaxed max-w-3xl mx-auto">
              Acompanhe o crescimento do negócio, gerencie o conteúdo e instituicaoistre os professores da plataforma.
            </p>  
          </div>
          <section className="flex flex-col xl:flex-row flex-wrap justify-center gap-8 md:gap-12 w-full px-4 md:px-0">

            <Link to="/instituicao/overview" className="group flex flex-col items-center text-center w-full md:w-auto max-w-[260px] md:max-w-none">
