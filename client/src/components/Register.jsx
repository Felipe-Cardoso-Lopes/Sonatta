          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-6 flex items-center">
              ...
              <label htmlFor="acceptTerms" className="text-sm text-white-text cursor-pointer">
                Eu concordo com os <Link to="/terms" className="hover:underline">Termos de Uso</Link> e <Link to="/privacy" className="hover:underline">Política de Privacidade</Link>.
              </label>
            </div>
