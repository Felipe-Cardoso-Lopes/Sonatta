...
const NavIndicator = ({ to, children }) => {
  ...
  // Usamos startsWith para que rotas filhas (ex: /teacher/management/edit) também ativem o indicador
      ...
      >
        <div className="flex flex-col items-center gap-6">
          ...
          <Link
            ...
            onClick={() => setIsMenuOpen(false)}
            className="w-13 h-13 scale-150 transition-transform hover:scale-125"
          >
            <img src="/assets/sonatta-logo.png" alt="Sonatta Logo" />
          </Link>

          <NavIndicator to="/teacher/management">
            <Link to="/teacher/management" onClick={() => setIsMenuOpen(false)} className="transition-transform hover:scale-125">
          ...
          <NavIndicator to="/teacher/overview">
            <Link to="/teacher/overview" onClick={() => setIsMenuOpen(false)} className="transition-transform hover:scale-125">
              <div className="w-14 h-14 bg-white rounded-[15px] flex items-center justify-center">
        ...
        <NavIndicator to="/teacher/profile">
          <Link to="/teacher/profile" onClick={() => setIsMenuOpen(false)} className="transition-transform hover:scale-125">
