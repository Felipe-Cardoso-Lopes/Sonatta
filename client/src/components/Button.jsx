...
function Button({ children, variant = 'primary', onClick, type = 'button', className = '' }) {
  ...
  if (variant === 'primary') {
    ...
    variantClasses = "bg-dark-bg text-pure-white border border-white-text hover:bg-white-text hover:text-dark-bg";
  } else if (variant === 'secondary') {
    // Mantém a lógica anterior: borda branca, texto branco; no hover, fundo branco, texto preto
    variantClasses = "border border-white-text text-pure-white hover:bg-white-text hover:text-dark-bg";
  }
