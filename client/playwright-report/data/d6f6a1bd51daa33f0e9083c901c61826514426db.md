...
Locator: locator('text=Cadastro recebido com sucesso!')
Expected: visible
Timeout: 60000ms
...
Call log:
  ...
  - waiting for locator('text=Cadastro recebido com sucesso!')
...
- img
- paragraph: Solicitação recebida com sucesso! A nossa equipe revisará os dados e entrará em contato em breve para liberar seu acesso.
...
```ts
  ...
  31 |     const successMessage = page.locator('text=Cadastro recebido com sucesso!');
